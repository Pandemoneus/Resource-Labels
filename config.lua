...
-- Pyanodon's Raw Ores
addItem ("copper-rock", "Copper Rock", "copper-ore")
addItem ("coal-rock", "Coal Rock", "raw-coal")
addItem ("chromium-rock", "Chromium Rock", "ore-chromium")
addItem ("ore-chromium", "Chromium", "ore-chromium")
addItem ("aluminium-rock", "Aluminium Rock", "ore-aluminium")
addItem ("ore-aluminium", "Aluminium", "ore-aluminium")
addItem ("zinc-rock", "Zinc Rock", "ore-zinc")
addItem ("ore-zinc", "Zinc", "ore-zinc")
addItem ("uranium-rock", "Uranium Rock", "uranium-ore")
addItem ("titanium-rock", "Titanium Rock", "ore-titanium")
addItem ("ore-titanium", "Titanium", "ore-titanium")
addItem ("tin-rock", "Tin Rock", "ore-tin")
addItem ("ore-tin", "Tin", "ore-tin")
addItem ("salt-rock", "Salt Rock", "salt")
addItem ("raw-coal", "Raw Coal", "raw-coal")
addItem ("quartz-rock", "Quartz Rock", "ore-quartz")
addItem ("ore-quartz", "Quartz", "ore-quartz")
addItem ("phosphate-rock-02", "Phosphate", "phosphate-rock")
addItem ("nickel-rock", "Nickel Rock", "ore-nickel")
addItem ("ore-nickel", "Nickel", "ore-nickel")
addItem ("nexelit-rock", "Nexelit Rock", "nexelit-ore")
addItem ("lead-rock", "Lead Rock", "ore-lead")
addItem ("ore-lead", "Lead", "ore-lead")
addItem ("iron-rock", "Iron Rock", "iron-ore")
